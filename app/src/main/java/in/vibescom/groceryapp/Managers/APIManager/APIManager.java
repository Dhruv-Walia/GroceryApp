...
public class APIManager implements Constants {
   ...
   * API Base URL
   */
  private static final String kAPIBaseURL  = "http://staging.peepsin.com/services/";
  ...
  private static final String kContentTypeRawJSON = "application/json; charset=utf-8";
  ...
  private RequestBody requestRawBody(Map<String, Object> parameter) {
    return RequestBody.create(okhttp3.MediaType.parse(kContentTypeRawJSON), new JSONObject(parameter).toString());
  }
